...
namespace Simplify
{
    ...
    static class AppCommandExtensions
    {
        ...
        static IntPtr Handle = Process.GetProcessesByName("explorer").First().MainWindowHandle;

        public static void Exec(this AppCommand cmd)
        {
            SendMessageW(Handle, WM_APPCOMMAND, Handle, (IntPtr)((int)cmd << 16));
        }
    }
